...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
 ...
 <ul>  <li>   <a href="http://studentweb.cencol.ca/phallan/assignment4/assignment4.html">
    ...
    <li><br /></li> <li>   <a href="http://studentweb.cencol.ca/phallan/Assignment22.html"><img src="Assest/images/Project2.PNG" class="project"/></a>This one is javascript project. It accepts the user input to create a table where number of rows and colums are decided by user and the table is created dynamically.</li></ul> 
   </div>
</asp:Content>
